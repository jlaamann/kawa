defmodule Kawa.Repo.Migrations.CreateWorkflowDefinitions do
  ...
  def up do
    create table(:workflow_definitions, primary_key: false) do
      ...
      add :default_timeout_ms, :integer, null: false, default: 300000
      add :default_retry_policy, :map, null: false, default: %{"max_retries" => 3, "backoff_ms" => 1000}
    ...
    create index(:workflow_definitions, [:client_id, :is_active], name: :idx_workflow_definitions_client_active)
